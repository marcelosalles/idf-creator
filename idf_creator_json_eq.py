...
def main_whole(zone_area = 10, zone_ratio = 1.5, zone_height = 3, absorptance = .5, shading = 1, azimuth = 0,
    ...
    zones_x_floor = 6, n_floors = 2, corner_window=True, input_file = "modelo.epJSON",output = 'output.epJSON'):
...
main_whole(zone_area = 10, zone_ratio = 1.5, zone_height = 3, absorptance = .5, shading = 0, azimuth = 0,
    corr_width = 2, wall_u = 2.5, wall_ct=100, corr_vent = 1, stairs = 0, zone_feat = zone_feat, concrete_eps=True,
    zones_x_floor = 6, n_floors = 4, corner_window=True, input_file = "seed_single.json",output = 'teste_cp_eq_whole.epJSON')
''' 
